...
/**
 * ExportPanel — Buttons for exporting the current sound as WAV, MP4, or JSON.
 */
export default function ExportPanel({ onExportWav, onExportMp4, onExportJson }) {
  ...
  return (
    <div className="rounded-2xl bg-white/5 border border-white/10 p-5">
      <h3 className="text-white font-semibold mb-1">Export Sound</h3>
      <p className="text-white/40 text-xs mb-3">
        Download your creation as an audio file or save the project
      </p>
